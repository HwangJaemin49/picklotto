 ...
 **PickLotto**는 직관적이고 세련된 디자인을 갖춘 프리미엄 로또 번호 생성기 웹 애플리케이션입니다. 단순한  
 랜덤 생성을 넘어 사용자가 원하는 조건을 설정하고 생성된 번호를 관리할 수 있는 기능을 제공합니다.    
                                                                                                           
 ## ✨ 주요 기능                                                                                           
                                                                                                           
 - **다양한 생성 모드**:                                                                                   
   - **완전 랜덤**: 클릭 한 번으로 무작위 번호 6개 추출.                                                   
   - **조건 설정 (반자동)**:                                                                               
     - **고정수**: 반드시 포함할 번호 선택 (최대 5개).                                                     
     - **제외수**: 결과에서 배제할 번호 선택 (최대 10개).                                                  
 - **시각적 애니메이션**: 로또 공이 튀어나오는 듯한 애니메이션 효과와 공식 로또 색상 적용.                 
 - **내 번호함 (저장 기능)**: 생성된 번호를 로컬 스토리지에 저장하여 나중에 다시 확인 가능 (날짜별 정렬).  
 - **반응형 디자인**: 모바일과 데스크톱 환경 모두에 최적화된 UI/UX.                                        
 ...
 *본 프로그램은 재미와 편의를 위해 제작되었으며, 실제 로또 당첨을 보장하지 않습니다.*
